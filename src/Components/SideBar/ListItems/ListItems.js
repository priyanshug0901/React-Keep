      ...
      <ul className={classes.ul}>
        ...
        <Link className={classes.sidebarContainer} to="/">
          ...
          <li className={classes.li} style={{color:color}} onClick={handleClick}>
           <HiOutlineMail style={{fill:fill}} onClick={handleClick} className={classes.svg} />Notes
          </li>

        </Link>

        <Link onClick={handleClickOutside} className={classes.sidebarContainer} to="/reminders">
